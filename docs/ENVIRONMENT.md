...
| VAR_NAME                | Default Value | Description |
| ----------------------- | ------------- | ----------- |
| LEGAL_ENTITIES_PER_PAGE | `50`          | Number of items per page for Legal Entities. |
| EMPLOYEES_PER_PAGE      | `50`          | Number of items per page for Employees. |
| DIVISIONS_PER_PAGE      | `15`          | Number of items per page for Divisions. |
